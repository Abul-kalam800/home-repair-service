...
const Footer = () => {
  return (
       ...
       <Link to='/'>
        ...
        <div>
          ...
          <ul className="flex justify-center items-center gap-5 mt-10">
            ...
            <li><Link to="https://www.facebook.com/bd.abulkalam800" className="text-blue-500"><FaFacebookF size={30}/></Link></li>
            <li><Link to='https://www.linkedin.com/in/mohammad-abul-kalam-226779303/' className="text-blue-500"><FaLinkedinIn  size={30}/> </Link></li>
            <li><Link to='https://www.youtube.com/@AbulKalam-800' className="text-blue-500"><FaYoutube size={30} /></Link></li>
          </ul>
    ...
    <div className="bg-base-300 py-10">
      <p className=" text-center "><span>Copyright: All rights reserved by Ak.services 2025 </span></p>
    </div>
    </div>
  );
};
